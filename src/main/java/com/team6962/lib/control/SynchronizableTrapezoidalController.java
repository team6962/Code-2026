 ...
 * Additionally, this controller supports stretching the motion profile to
 * make it take longer than the minimum time required by the physical
 * constraints of the system, allowing multiple controllers to be synchronized
 * to reach their goal states at the same time.
 * 
 * <h3>Usage</h3>
 * 
 * To use this controller, first create an instance of the
 * {@link SynchronizableTrapezoidalController} class, providing the PID constants, motion
 ...
 */
public class SynchronizableTrapezoidalController {
    /**
    ...
    public SynchronizableTrapezoidalController(
