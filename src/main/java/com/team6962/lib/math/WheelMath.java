...
/**
 * Utility class for converting between wheel angular measurements and linear measurements at the
 * edge of the wheel.
 */
public class WheelMath {
  /**
   * Converts an angle that a wheel has rotated to the linear distance that the edge of the wheel
   * travels.
   *
  ...
  /**
   * Converts a linear distance traveled at the edge of a wheel to the angle that the wheel has
   * rotated.
   *
  ...
  /**
   * Converts an angular velocity of a wheel to the linear velocity at the edge of the wheel.
   *
  ...
  /**
   * Converts a linear velocity at the edge of a wheel to the angular velocity of the wheel.
   *
  ...
  /**
   * Converts an angular acceleration of a wheel to the linear acceleration at the edge of the
   * wheel.
   *
   ...
   */
  public static LinearAcceleration toLinear(
      AngularAcceleration angularAcceleration, Distance radius) {
    return MetersPerSecondPerSecond.of(
        angularAcceleration.in(RadiansPerSecondPerSecond) * radius.in(Meters));
  }

  /**
   * Converts a linear acceleration at the edge of a wheel to the angular acceleration of the wheel.
   *
   * @param linearAcceleration The linear acceleration at the edge of the wheel
   * @param radius The radius of the wheel
   * @return The angular acceleration of the wheel
   */
  public static AngularAcceleration toAngular(
      LinearAcceleration linearAcceleration, Distance radius) {
    return RadiansPerSecondPerSecond.of(
        linearAcceleration.in(MetersPerSecondPerSecond) / radius.in(Meters));
  }
}
