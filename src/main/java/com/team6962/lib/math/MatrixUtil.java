...
public class MatrixUtil {
    /**
     * Converts a 2D vector to a 3D vector with the components (x, y, 1). This
     * allows the vector to be translated using a 3x3 transformation matrix.
     * 
    ...
    /**
     * Creates a 2x2 rotation matrix that rotates vectors counterclockwise
     * around the origin by the specified angle.
     * 
    ...
    /**
     * Creates a 2x2 rotation matrix from a direction vector, where the first
     * component is the cosine of the angle and the second component is the sine
     * of the angle. If the magnitude of the direction vector is not 1, the
     * resulting matrix will also scale vectors by that magnitude.
     * 
     * @param direction The direction vector containing the cosine and sine of
     *                  the angle
     * @return The 2x2 rotation matrix
     */
    ...
    /**
     * Converts a 2x2 matrix to a 3x3 matrix by embedding it in the top-left
     * corner and setting the bottom-right element to 1. The resulting matrix
     * is capable of translating 2D vectors, unlike the original 2x2 matrix.
     * 
    ...
    /**
     * Converts a 3x3 matrix to a 2x2 matrix by extracting the top-left 2x2
     * submatrix. The resulting matrix does not translate vectors, unlike the
     * original 3x3 matrix.
     * 
    ...
    /**
     * Creates a 3x3 translation matrix that translates vectors by the specified
    ...
    /**
     * Creates a 3x3 rotation matrix that rotates vectors counterclockwise
     * around the origin by the specified angle.
     * 
     * @param angle The angle to rotate by
    ...
    /**
     * Creates a 3x3 rotation matrix from a direction vector, where the first
     * component is the cosine of the angle and the second component is the sine
     * of the angle. If the magnitude of the direction vector is not 1, the
     * resulting matrix will also scale vectors by that magnitude.
     * 
