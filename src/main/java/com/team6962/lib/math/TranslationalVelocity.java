...
/**
 * Represents a 2D translational velocity with x and y components. The components are represented by
 * measures, allowing for unit-safe calculations.
 */
public class TranslationalVelocity {
  ...
  /**
   * Creates a TranslationalVelocity from a ChassisSpeeds object. The angular velocity is ignored.
   *
  ...
  /**
   * Creates a TranslationalVelocity from a Translation2d object and a time interval. The
   * translation components are divided by the time interval to obtain the velocity components.
   *
  ...
  /**
   * Creates a TranslationalVelocity from a Translation2d object. The components are treated as
   * velocities in meters per second.
   *
   * @param translationalVelocity The Translation2d object representing the translational velocity
   */
  ...
  /**
   * Creates a TranslationalVelocity with the specified x and y components in meters per second.
   *
   * @param vxMetersPerSecond The x-component of the translational velocity in meters per second
   * @param vyMetersPerSecond The y-component of the translational velocity in meters per second
   */
  ...
  /**
   * Creates a TranslationalVelocity from a 2D vector. The first component is the x-component and
   * the second component is the y-component, both in meters per second. Any additional components
   * are ignored.
   *
  ...
  /**
   * Calculates the direction of the translational velocity vector as an angle measure.
   *
  ...
  /**
   * Subtracts another TranslationalVelocity from this one and returns the result.
   *
  ...
  /**
   * Rotates this TranslationalVelocity by the specified angle and returns the result.
   *
  ...
  public TranslationalVelocity rotateBy(Angle angle) {
    ...
    return new TranslationalVelocity(MetersPerSecond.of(rotatedX), MetersPerSecond.of(rotatedY));
  }

  /**
   * Rotates this TranslationalVelocity by the specified Rotation2d angle and returns the result.
   *
  ...
  public String toString() {
    return String.format(
        "TranslationalVelocity(Vx: %.2f, Vy: %.2f)", x.in(MetersPerSecond), y.in(MetersPerSecond));
  }
}
