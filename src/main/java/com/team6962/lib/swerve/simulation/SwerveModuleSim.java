...
/**
 * Simulates a complete swerve module by combining drive and steer mechanism
 * simulations.
 *
 * <p>This class composes {@link DriveMechanismSim} and
 * {@link SteerMechanismSim} to provide a unified simulation of a swerve
 * module. It extracts the necessary hardware references from a real
 * {@link SwerveModule} to initialize the mechanism simulations.
 *
 * <p>Getter methods provide access to the individual mechanism simulations
 * as well as combined state in WPILib's {@link SwerveModulePosition} and
 * {@link SwerveModuleState} formats for use with kinematics and odometry.
 *
 * <p>The {@link #update(double)} method delegates to both mechanism
 * simulations and should be called periodically to advance the physics
 * simulation.
 */
