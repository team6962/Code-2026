...
public class SteerEncoderConstants {
    ...
    /**
     * The method to use for fusing absolute steer encoder data with more
     * quickly updating data from the steer motor's internal encoder. When
     * using Phoenix Pro, Fused mode is recommended, and otherwise Remote mode
     * is the only option.
     */
    ...
    /**
     * Sets the data fusion method for the steer encoder, and returns this
     * SteerEncoderConstants for chaining.
     * 
    ...
    public static enum DataFusionMethod {
        /**
         * The motor controller will update its position and velocity whenever
         * the encoder publishes its information on CAN bus, and the motor's
         * internal encoder will not be used.
         */
        Remote(FeedbackSensorSourceValue.RemoteCANcoder),

        /**
         * Requires Phoenix Pro; the motor controller will fuse the absolute
         * encoder's information with the data from the internal encoder,
         * providing the best possible position and velocity for accuracy and.
         * FusedCANcoder is designed for swerve steering motors.
         */
        Fused(FeedbackSensorSourceValue.FusedCANcoder);

        /**
         * The FeedbackSensorSourceValue that is equivalent to this
         * DataFusionMethod.
         */
