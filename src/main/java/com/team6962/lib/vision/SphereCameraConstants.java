...
/**
 * Configuration constants for a sphere detection camera. This class
 * defines camera properties, detection parameters, and physical mounting
 * position for a camera used to detect and locate sphere game pieces on the
 * field.
 */
public class SphereCameraConstants {
    ...
    /**
     * Maximum range at which sphere pieces can be detected. Default is the
     * diagonal length of the field.
     */
    public Distance MaxDetectionRange = Meters.of(18.37);

    /**
     * Tolerance for sphere detection algorithm. This affects how closely a
     * detected object must match a spherical shape to be considered a sphere
     * piece.
     */
    ...
    /**
     * Constructs a SphereCameraConstants with the specified camera name. Other
     * fields need to be set via the 'with' methods before these constants can be used.
     *
