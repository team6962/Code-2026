...
public class AprilTagCameraConstants {
    ...
    /**
     * Sets the name of the camera, and returns this AprilTagCameraConstants for
     * chaining.
     * 
    ...
    /**
     * Sets the transform from the robot to the camera, and returns this
     * AprilTagCameraConstants for chaining.
     * 
