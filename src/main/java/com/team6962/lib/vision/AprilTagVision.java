...
/**
 * Subsystem that manages AprilTag-based vision systems for robot localization.
 * This class coordinates multiple cameras to provide pose estimates that are
 * integrated with the swerve drive's odometry.
 */
public class AprilTagVision extends SubsystemBase {
     ...
     *
     * @param swerveDrive The swerve drive subsystem to integrate vision
     *            measurements with.
     * @param visionConstants Configuration constants for the vision system,
     *            including field layout and camera specifications.
     */
