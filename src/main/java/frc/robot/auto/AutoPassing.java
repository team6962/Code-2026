        ...
        return Commands.sequence(
            ...
            robot.getTurret().moveTo(
                () -> {
                    ...
                    return target.minus( // Calculate the translational difference between the target and shooter
                            robot.getSwerveDrive().getPosition2d() // Get robot position
                            .plus( // Add the small offset between the center of the robot and the shooter location
                                new Transform2d(RobotVisualizationConstants.shooterTranslation.toTranslation2d(), Rotation2d.kZero))
                            .getTranslation())
