...
public class IntakeRollers extends SubsystemBase {
  ...
  private Command move(Voltage voltage) {
    return runEnd(
        () -> {
          intakeMotor.setControl(new VoltageOut(voltage.times(voltageScale)).withEnableFOC(false));
        },
        () -> {
    ...
    return runEnd(
        () -> {
          intakeMotor.setControl(
              new VoltageOut((stalling ? intakeStallVoltage : intakeVoltage) * voltageScale)
                  .withEnableFOC(false));
        },
        () -> {
          intakeMotor.setControl(new CoastOut());
  ...
  public Command intakeFast() {
    return runEnd(
        () -> {
          intakeMotor.setControl(
              new VoltageOut(RobotController.getBatteryVoltage() * voltageScale)
                  .withEnableFOC(false));
        },
        () -> {
          intakeMotor.setControl(new CoastOut());
  ...
  public void periodic() {
    ...
    DogLog.log("intakeRollers/voltageScale", voltageScale);
