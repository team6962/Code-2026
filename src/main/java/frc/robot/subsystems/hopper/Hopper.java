 ...
 * and Sensors, which grabs it from their respective subsystem file
 */
public class Hopper extends SubsystemBase {
    ...
    /**
     * Command to feed the hopper, which runs the belt floor and kicker for a short time or until the kicker is empty
     * @return
     */
    public Command feed() {
    ...
    /**
     * Command to eject the hopper, which runs the belt floor and kicker 
     * in reverse for a short time or until the hopper is empty
     * @return
     */
    ...
    /**
     * Command to check if the hopper is empty, which checks the sensors for both the hopper and kicker
     * @return
     */
