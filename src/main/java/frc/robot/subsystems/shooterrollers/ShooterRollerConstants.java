...
public final class ShooterRollerConstants {
    ...
    public static final MomentOfInertia MOMENT_OF_INERTIA = KilogramSquareMeters.of(5); //change later according to what Tyler will put on the tech binder tomorrow
