...
class VelocityControlRequestTest {
  ...
  void withVelocityDouble() {
    VelocityControlRequest request = new VelocityControlRequest(0.0).withVelocity(10.0);
    assertEquals(10.0, request.Velocity);
  }

  @Test
  void withVelocityAngularVelocity() {
    VelocityControlRequest request =
        new VelocityControlRequest(0.0).withVelocity(RotationsPerSecond.of(7.5));
    assertEquals(7.5, request.Velocity, 0.0001);
  }

  @Test
  void withSlot() {
    VelocityControlRequest request = new VelocityControlRequest(0.0).withSlot(2);
    assertEquals(2, request.Slot);
  }

  @Test
  void withUpdateFreqHz() {
    VelocityControlRequest request = new VelocityControlRequest(0.0).withUpdateFreqHz(100.0);
    assertEquals(100.0, request.UpdateFreqHz);
  }

  @Test
  void withUseTimesync() {
    VelocityControlRequest request = new VelocityControlRequest(0.0).withUseTimesync(true);
  ...
  void withMotionProfileType() {
    VelocityControlRequest request =
        new VelocityControlRequest(0.0).withMotionProfileType(VelocityMotionProfileType.None);
  ...
  void withOutputType() {
    VelocityControlRequest request =
        new VelocityControlRequest(0.0).withOutputType(ControlOutputType.TorqueCurrentFOC);
  ...
  void chainingMethods() {
    VelocityControlRequest request =
        new VelocityControlRequest(1.0)
            .withVelocity(2.0)
            .withSlot(1)
  ...
  void toControlRequest_NoneVoltage() {
    VelocityControlRequest request =
        new VelocityControlRequest(5.0)
            .withSlot(1)
