...
class PositionControlRequestTest {
  ...
  void withPositionDouble() {
    PositionControlRequest request = new PositionControlRequest(0.0).withPosition(10.0);
    assertEquals(10.0, request.Position);
  }

  @Test
  void withPositionAngle() {
    PositionControlRequest request =
        new PositionControlRequest(0.0).withPosition(Rotations.of(7.5));
    assertEquals(7.5, request.Position, 0.0001);
  }

  @Test
  void withSlot() {
    PositionControlRequest request = new PositionControlRequest(0.0).withSlot(2);
    assertEquals(2, request.Slot);
  }

  @Test
  void withUpdateFreqHz() {
    PositionControlRequest request = new PositionControlRequest(0.0).withUpdateFreqHz(100.0);
    assertEquals(100.0, request.UpdateFreqHz);
  }

  @Test
  void withUseTimesync() {
    PositionControlRequest request = new PositionControlRequest(0.0).withUseTimesync(true);
  ...
  void withMotionProfileType() {
    PositionControlRequest request =
        new PositionControlRequest(0.0)
  ...
  void withOutputType() {
    PositionControlRequest request =
        new PositionControlRequest(0.0).withOutputType(ControlOutputType.TorqueCurrentFOC);
  ...
  void chainingMethods() {
    PositionControlRequest request =
        new PositionControlRequest(1.0)
            .withPosition(2.0)
            .withSlot(1)
  ...
  void toControlRequest_NoneVoltage() {
    PositionControlRequest request =
        new PositionControlRequest(5.0)
            .withSlot(1)
