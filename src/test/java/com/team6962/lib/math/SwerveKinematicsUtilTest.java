...
class SwerveKinematicsUtilTest {
    ...
    void optimizeRelativePosition_SmallAngle_NoInversion() {
        ...
        SwerveModulePosition result = SwerveKinematicsUtil.optimizeRelativePosition(position, currentSteerAngle);
    ...
    void optimizeAbsolutePosition_LargeAngle_DoesNotInvertDistance() {
        ...
        SwerveModulePosition result = SwerveKinematicsUtil.optimizeAbsolutePosition(position, currentSteerAngle);
    ...
    void decreaseVelocityIfMisaligned_PerfectlyAligned_NoChange() {
        ...
        SwerveModuleState result = SwerveKinematicsUtil.decreaseVelocityIfMisaligned(target, currentSteerAngle);
